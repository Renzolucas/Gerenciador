...
import com.sistema_gerenciamento_solicitacoes_atendimentos.sistema_gerenciamento_solicitacoes_atendimentos.repository.TaskRepository;
...
import com.sistema_gerenciamento_solicitacoes_atendimentos.sistema_gerenciamento_solicitacoes_atendimentos.domain.task.CreateTaskBodyDTO;
@Service
public class TaskService {
    ...
    public Task createTask(CreateTaskBodyDTO dto){
        ...
        Users admin = usersRepository.findById(dto.getUsersAdminId())
            .orElseThrow(() -> new RuntimeException("Funcionário não encontrado com o ID: " + dto.getUsersAdminId()));
